          ...
          <div className="footer__top">
            ...
            <div className="footer-content">
              ...
              <div className="footer__contact">
                <ul className="footer__brand--menu footer__menu">
                  <li className="footer__brand--item">info@mediacurrent.com</li>
                  <li className="footer__brand--item">Phone: 678.580.1690</li>
                  <li className="footer__brand--item">
                    Toll Free: 866.507.0005
                  </li>
                  <li className="footer__brand--item">Fax: 770.360.5776</li>
                </ul>
              </div>
            </div>
              ...
              <nav className="footer__menu--social">
                <ul className="footer__social">
                  <li className="footer__menu--item">
                    <a
                      href="http://twitter.com/mediacurrent"
                  ...
                  <li className="footer__menu--item">
                    <a
                      href="https://www.facebook.com/pages/Mediacurrent/172384302846690"
                      className="footer__menu--link"
                    >
                  ...
                  <li className="footer__menu--item">
                    <a
                      href="https://www.youtube.com/user/MediacurrentDrupal"
                      className="footer__menu--link"
                    >
                  ...
                  <li className="footer__menu--item">
                    <a
                      href="https://www.linkedin.com/company/mediacurrent/"
                      className="footer__menu--link"
                    >
        ...
        <div className="footer__bottom">
          <div className="footer__bottom--inner component-item__inner">
            <p className="footer__copyright">
              &copy; 2007 - {new Date().getFullYear()} Mediacurrent Interactive
